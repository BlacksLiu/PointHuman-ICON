...
def render_subject(subject, dataset, save_folder, rotation, size, render_types, egl):
    ...
    try:
        ...
        # Important! When rendering depth image, please MUST set ms_rate as 1.
        # Important! While rendering others, please MUST set ms_rate as 16.
        ...
        for y in range(0, 360, 360 // rotation):
            ...
            # calib
            calib = opengl_util.load_perspective_calib(dic, render_size=size)
